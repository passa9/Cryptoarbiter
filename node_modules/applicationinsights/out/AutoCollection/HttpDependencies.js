            ...
            if (client.config && client.config.correlationId) {
                ...
                if (correlationHeader) {
                    ...
                    if (!components.some(function (value) { return value.substring(0, key_1.length) === key_1; })) {
                        telemetry.request.setHeader(RequestResponseHeaders.requestContextHeader, correlationHeader + "," + RequestResponseHeaders.requestContextSourceKey + "=" + client.config.correlationId + "," + RequestResponseHeaders.requestContextSourceRoleNameKey + "=" + client.context.tags[client.context.keys.cloudRole]);
                    }
                }
                else {
                    telemetry.request.setHeader(RequestResponseHeaders.requestContextHeader, RequestResponseHeaders.requestContextSourceKey + "=" + client.config.correlationId + "," + RequestResponseHeaders.requestContextSourceRoleNameKey + "=" + client.context.tags[client.context.keys.cloudRole]);
                }
            }
