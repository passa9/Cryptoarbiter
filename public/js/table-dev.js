        ...
        "columns": [
            ...
            },
            {
                "data": "bittrex", "orderable": true, render: function (data, type, row, meta) {
                    ...
                    cell += '<font size="2">';
                    if (differenceBid == 1) {
                        cell += '<a href="#" style="color:green">' + ((data.bid != undefined) ? data.bid.toFixed(8) : '0') + '</a>'
                    }
                    if (differenceBid == 0) {
                        cell += '<a href="#" style="color:black">' + ((data.bid != undefined) ? data.bid.toFixed(8) : '0') + '</a>'
                    }
                    if (differenceBid == -1) {
                        cell += '<a href="#" style="color:red">' + ((data.bid != undefined) ? data.bid.toFixed(8) : '0') + '</a>'
                    }
                    '</div></div></div></div>';
